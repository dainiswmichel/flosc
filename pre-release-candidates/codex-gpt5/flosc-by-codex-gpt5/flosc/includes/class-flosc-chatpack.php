...
class FLOSC_Chatpack {
    ...
    public static function build_followup_chatpack($phase, $eval_context, $session_hash, $pair_number, $ivr_guidance = null, $previous_phase = null) {
        ...
        // Resolve and send the complete current profile on every turn. This also
        // makes an admin's mid-conversation personality switch effective on the
        // visitor's very next request without starting a new session.
