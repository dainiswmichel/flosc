...
class FLOSC_Chatpack {
    ...
    public static function build_followup_chatpack($phase, $eval_context, $session_hash, $pair_number, $ivr_guidance = null, $previous_phase = null) {
        ...
        // section is flow-scoped, so re-sending the complete current profile on every
        // turn keeps each chatbot firmly inside its own flow and lets a changed
        // personality_library_id take effect on the next reply.
