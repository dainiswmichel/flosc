...
if ( function_exists( 'flosc_render_personality_designer_accordion' ) ) {
	$flosc_design_pid = $flosc_personality_id;
	if ( function_exists( 'flosc_personality_builder_request_context' ) ) {
		$flosc_design_ctx = flosc_personality_builder_request_context();
		if ( ! empty( $flosc_design_ctx['persona'] ) ) {
			$flosc_design_pid = sanitize_key( (string) $flosc_design_ctx['persona'] );
		}
	}
	flosc_render_personality_designer_accordion( $flosc_design_pid, (string) $flosc_current_ivr );
}
?>
