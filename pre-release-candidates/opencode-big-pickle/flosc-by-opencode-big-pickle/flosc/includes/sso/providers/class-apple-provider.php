...
class Apple_Provider extends SSO_Provider_Base {
	...
	public function get_user_info( $access_token, $token_data = array() ) {
		 ...
		 */
		// phpcs:disable WordPress.Security.NonceVerification.Missing, WordPress.Security.NonceVerification.Recommended -- Apple form_post callback; CSRF control is the OAuth `state` verified in the handler before this provider is invoked.
