...
/**
 * Coordinate FLOSC REST Trait behavior and the WordPress services used by its methods.
 */
 ...
 * @return bool Whether check checkout endpoint permission applies to the current state.
	...
	public function check_checkout_endpoint_permission( $request ) {
		...
		if ( ! wp_verify_nonce( $nonce, 'wp_rest' ) ) {
			return new WP_Error( 'forbidden', __( 'Invalid or missing security token.', 'flosc' ), array( 'status' => 403 ) );
		}
		return true;
	}
 ...
 * @return bool Whether check checkout finalization permission applies to the current state.
	...
	public function check_checkout_finalization_permission( $request ) {
		...
		if ( ! is_array( $binding_record ) ) {
			return new WP_Error( 'flosc_invalid_checkout_binding', __( 'Invalid checkout binding token.', 'flosc' ), array( 'status' => 403 ) );
		}
 ...
 * @return bool Whether check webhook endpoint permission applies to the current state.
	...
	public function check_webhook_endpoint_permission( $request ) {
		...
		if ( ! in_array( $provider, array( 'stripe', 'paypal', 'clickbank' ), true ) ) {
			return new WP_Error( 'flosc_invalid_webhook_provider', __( 'Invalid webhook provider.', 'flosc' ), array( 'status' => 400 ) );
		}
		return true;
	}
	...
	private function normalize_ivr_phase( $raw_phase ) {
		...
		$valid_phases = array( 'freeline', 'login', 'offer', 'sale', 'content' );
		if ( ! in_array( $phase, $valid_phases, true ) ) {
			return new WP_Error( 'flosc_invalid_phase', __( 'Invalid FLOSC phase.', 'flosc' ), array( 'status' => 400 ) );
		}
 ...
 * @return bool Whether check ivr messages permission applies to the current state.
	...
	public function check_visitor_session_poll_permission( $request ) {
		...
		if ( ! $this->verify_admin_poll_token( $session_id, $poll_token ) ) {
			return new WP_Error( 'flosc_invalid_session_token', __( 'Invalid session token.', 'flosc' ), array( 'status' => 403 ) );
		}
		...
		if ( ! $this->check_rate_limit( 'visitor_admin_poll_' . $session_id, 120, HOUR_IN_SECONDS ) ) {
			return new WP_Error( 'flosc_rate_limit', __( 'Too many requests.', 'flosc' ), array( 'status' => 429 ) );
		}
	...
	public function register_rest_routes() {
		...
		register_rest_route(
			...
			array(
				...
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_chat_with_rag' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_admin_messages_poll' ),
				// Requires session-bound poll_token (minted via /admin-messages-token).
				'permission_callback' => array( $this, 'check_visitor_session_poll_permission' ),
			)
		);
		...
		register_rest_route(
			'flosc/v1',
			'/admin-messages-token',
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_admin_messages_token' ),
				'permission_callback' => array( $this, 'check_admin_messages_token_permission' ),
			)
		);
		...
		register_rest_route(
			'flosc/v1',
			'/visitor-session-balance',
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_visitor_session_balance' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			'flosc/v1',
			'/apply-guest-token-grant',
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_apply_guest_token_grant' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_quiz_submission' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'store_quiz_result' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				...
				'permission_callback' => array( $this, 'check_metered_visitor_compute_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_process_audio' ),
				'permission_callback' => array( $this, 'check_metered_visitor_compute_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_process_quiz' ),
				'permission_callback' => array( $this, 'check_metered_visitor_compute_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'get_single_session' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'PUT',
				'callback'            => array( $this, 'rename_session' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				...
				'permission_callback' => array( $this, 'check_public_nonce_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'get_offer_content' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_sandbox_purchase' ),
				'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				...
				'callback'            => array( $this, 'get_free_lesson' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				...
				'permission_callback' => array( $this, 'check_checkout_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'complete_purchase' ),
				'permission_callback' => array( $this, 'check_checkout_finalization_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'paypal_get_plans' ),
				'permission_callback' => array( $this, 'check_checkout_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			'flosc/v1',
			'/paypal/prepare-subscription',
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'paypal_prepare_subscription' ),
				'permission_callback' => array( $this, 'check_checkout_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'paypal_activate_subscription' ),
				'permission_callback' => array( $this, 'check_checkout_finalization_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_checkout_binding' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				...
				'permission_callback' => array( $this, 'check_webhook_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => array( 'GET', 'POST' ),
				'callback'            => array( $this, 'handle_session_bootstrap' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'get_token_balance' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'declare_intent' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			'flosc/v1',
			'/intents/(?P<id>[a-z0-9_]+)/offers',
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'get_intent_offers' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'get_ivr_messages' ),
				'permission_callback' => array( $this, 'check_ivr_messages_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'handle_oembed' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'get_bridge_data' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		if ( defined( 'FLOSC_DEBUG' ) && FLOSC_DEBUG ) {
			register_rest_route(
				...
				array(
					'methods'             => 'GET',
					'callback'            => array( $this, 'get_debug_funnel_state' ),
					'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
				)
			);
		}
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'store_prelogin_score' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'store_visitor_audio' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'mark_funnel_complete' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_test_ai' ),
				'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_ivr_track' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'handle_ivr_get_messages' ),
				'permission_callback' => array( $this, 'check_ivr_messages_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_email_registration' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_stash_visitor_quiz' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_update_guest_profile' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_score_pending_audio' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_store_quiz_data' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_save_feedback' ),
				'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'handle_get_feedback' ),
				'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			'flosc/v1',
			'/feedback/(?P<feedback_id>[a-z0-9]+)',
			array(
				'methods'             => 'DELETE',
				'callback'            => array( $this, 'handle_delete_feedback' ),
				'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_save_praise' ),
				'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			'flosc/v1',
			'/praises/(?P<praise_id>[a-z0-9_]+)',
			array(
				'methods'             => 'DELETE',
				'callback'            => array( $this, 'handle_delete_praise' ),
				'permission_callback' => array( $this, 'check_admin_endpoint_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_redeem_access_code' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_apply_offer_coupon' ),
				'permission_callback' => array( $this, 'check_authenticated_user_permission' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_client_chat_log' ),
				'permission_callback' => array( $this, 'check_public_endpoint_permission' ),
			)
		);
	}
