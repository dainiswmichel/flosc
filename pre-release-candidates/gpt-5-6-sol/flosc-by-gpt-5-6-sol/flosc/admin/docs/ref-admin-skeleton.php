...
/*
 * The two documentation pages this one links out to at the foot of the AI
 * section. They are named here rather than built inside the href attributes
 * down there: a long add_query_arg() call inside an attribute gets split across
 * lines by a formatting pass, which puts a newline inside the attribute value.
 */
$flosc_ref_ai_config_doc_url = add_query_arg(
	array(
		'page' => 'flosc-settings',
		'ivr'  => $flosc_ref_ivr,
		'tab'  => 'documentation',
...
$flosc_ref_glossary_doc_url  = add_query_arg(
	array(
		'page' => 'flosc-settings',
		'ivr'  => $flosc_ref_ivr,
		'tab'  => 'documentation',
...
$flosc_feature_links = array(
	...
	'token-management' => add_query_arg(
		array(
			'page' => 'flosc-settings',
			'ivr'  => $flosc_ref_ivr,
...
<a href="<?php echo esc_url( $flosc_ref_ai_config_doc_url ); ?>">AI Configuration Guide</a>
· <a href="<?php echo esc_url( $flosc_ref_glossary_doc_url ); ?>#glossary-turns">Glossary: turns &amp; messages</a>
· <a href="<?php echo esc_url( $flosc_ref_glossary_doc_url ); ?>#term-available-providers">Available Providers</a>
</p>
