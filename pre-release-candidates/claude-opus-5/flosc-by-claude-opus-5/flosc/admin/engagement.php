...
$flosc_tab_url                       = static function ( $tab ) use ( $flosc_base_q ) {
	return add_query_arg( array_merge( $flosc_base_q, array( 'tab' => $tab ) ), admin_url( 'admin.php' ) );
};
$flosc_engagement_docs_url           = add_query_arg(
	array_merge(
		$flosc_base_q,
		array(
			'tab' => 'documentation',
...
$flosc_engagement_docs_inventory_url = add_query_arg(
	array_merge(
		$flosc_base_q,
		array(
			'tab' => 'documentation',
...
<div class="flosc-flow-overview">
	...
	<div class="flosc-engagement-summary-scroll">
		<table class="widefat striped flosc-login-activity-table flosc-eng-table-flush">
			...
			<?php else : ?>
				<?php
				foreach ( $flosc_summary_users as $flosc_u ) :
