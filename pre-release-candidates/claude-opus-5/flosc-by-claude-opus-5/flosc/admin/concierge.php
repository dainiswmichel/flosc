...
$flosc_files        = function_exists( 'flosc_config_glob' ) ? flosc_config_glob( array( '*_ivr.md', 'ivr*.md' ) ) : array();
...
/*
 * This feeds the concierge picker below, so anything the query drops is a post
 ...
 */
$flosc_concierge_posts = flosc_get_posts_all(
	array(
		'post_type'     => 'post',
...
$flosc_concierge_posts = array_values(
	array_filter(
		(array) $flosc_concierge_posts,
		static function ( $flosc_post ) use ( $flosc_selected_ivr ) {
