...
abstract class FLOSC_Payment_Provider {
    ...
    public function process_refund($user_id, $transaction_id, $amount = null) {
        return new WP_Error('not_supported', 'Refunds not supported by this provider');
    }
    ...
    public function handle_webhook($payload, $headers = []) {
        return new WP_Error('not_supported', 'Webhooks not supported by this provider');
    }
    ...
    public function cancel_subscription($subscription_id) {
        return new WP_Error('not_supported', 'Subscriptions not supported by this provider');
    }
