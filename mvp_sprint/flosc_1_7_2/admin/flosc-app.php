...
<body class="flosc-app"
    ...
    <div class="flosc-modal-overlay" id="flosc_modal_payment">
        <div class="flosc-modal flosc-payment-modal">
            ...
            <div class="flosc-modal-body">
                ...
                <!-- v1.7.2: PayPal Smart Payment Button -->
                <div id="paypal-button-container" style="margin-bottom: 16px;"></div>

                <!-- Divider between PayPal and card -->
                <div id="payment-divider" style="text-align: center; margin: 12px 0; color: #9ca3af; font-size: 13px;">
                    <span style="background: #fff; padding: 0 12px;">or pay with card</span>
                </div>
    ...
    <script>
        ...
        window.FLOSC_CONFIG = <?php 
            ...
            'paypalMode' => $providers['paypal']['config']['mode'] ?? 'sandbox',
