    ...
    <div class="card" style="max-width: 800px; margin-top: 20px; padding: 20px;">
        ...
        <?php if ($current_tab === 'identity' || $is_new): ?>
            ...
            <form method="post">
                ...
                <p class="description">Configure the profile bar shown to non-logged-in visitors (bottom left of sidebar).</p>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="visitor_bar_icon" name="visitor_bar_icon"
                                   value="<?php echo esc_attr(get_option('flosc_visitor_bar_icon', '👋')); ?>"
                                   style="width: 60px; font-size: 24px; text-align: center;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="visitor_bar_text" name="visitor_bar_text"
                                   value="<?php echo esc_attr(get_option('flosc_visitor_bar_text', 'Sign in to get started')); ?>"
                                   class="large-text">
