...
- **Visitor menu "Take quiz" fixed** — Now triggers quiz correctly using normalized IVR phrase "start free quiz"
- **"Browse all lessons" improved** — Shows diagnostic info and helpful admin instructions when lessons are missing
- **Guest profile bar layout fixed** — Now correctly positioned at bottom of sidebar with proper flex spacing
- **Hamburger menu visible** — Fixed malformed CSS hex color that made menu icon invisible
- **"View my free lesson" routing fixed** — Correctly handles category ID vs slug for lesson retrieval
- **Duplicate FLOSC branding removed** — Desktop shows only sidebar logo, mobile shows only header logo

### ✨ New Configurability Features (Priority 3)
- **UI & Navigation Admin Page** — New dedicated settings page under FLOSC menu
- **Visitor Menu Configuration** — Customize labels, enable/disable menu items via admin
- **Login Destination Options** — Choose where users redirect after login (My Account, Profile, Home, or stay on Chat)
- **Visitor Bar Customization** — Configure engagement bar text and icon/emoji
- **Normalized Quiz Triggers** — Standardized on "start free quiz" as canonical IVR phrase
- **Built-in Documentation** — Comprehensive help text for IVR triggers and profile menu customization

📖 **Full Details:** See [`CHANGELOG_1_8_0.md`](CHANGELOG_1_8_0.md)

---

## 🆕 What's New in v1.7.9 (Previous Release)
