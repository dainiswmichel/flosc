...
Purchased: ${ctx.purchased}
        ...
        try {
            ...
            if (response) {
                ...
                if (ivrGuidance) {
                    ...
                    this.addMessage('assistant', content);
                    if (ivrGuidance.action) this.performIVRAction(ivrGuidance.action);
                } else {
    ...
    showCorrectionModal(userMessage, aiResponse) {
        ...
        modal.querySelector('.flosc-correction-submit').addEventListener('click', async () => {
            ...
            try {
                const res = await fetch(this.config.apiUrl + '/corrections', {
                    method: 'POST',
                    credentials: 'same-origin',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    showPraiseModal(userMessage, aiResponse) {
        ...
        modal.querySelector('.flosc-correction-submit').addEventListener('click', async () => {
            ...
            try {
                const res = await fetch(this.config.apiUrl + '/praises', {
                    method: 'POST',
                    credentials: 'same-origin',
                    headers: {
                        'Content-Type': 'application/json',
