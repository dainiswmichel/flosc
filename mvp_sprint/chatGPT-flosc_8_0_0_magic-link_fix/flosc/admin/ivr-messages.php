            ...
            if (empty($mismatches)) {
                ...
                $diagnostics['sync_status'] = [
                    ...
                    'details' => [
                        ...
                        'Press "Compare" to see field-level details, or "Resync" to save your FLOSC DB edits to the file.'
                    ]
                ];
            }
        } else {
    ...
    <div style="border-top: 1px solid #dee2e6; padding-top: 20px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 18px;">
            ...
            <div style="background: #f0faf0; border: 2px solid #a5d6a7; border-radius: 8px; padding: 18px;">
                ...
                <p style="margin: 0 0 14px; font-size: 12px; color: #444; line-height: 1.5;">
                    The file is your source of truth. Load it into the DB so the frontend chat
                    serves the updated messages. A backup is created automatically.
                </p>
                <form method="post">
        ...
        <div style="background: white; padding: 15px; margin: 15px 0; border: 1px solid #ddd;">
            ...
            <ul style="margin: 5px 0 0 20px; line-height: 2;">
                ...
                <li style="color: #d63638;">⚠️ <strong>Will be removed:</strong> <?php echo count($import_preview['deleted']); ?>
                    <details style="display:inline-block; vertical-align:middle; margin-left:6px;">
                        <summary style="cursor:pointer; color:#d63638; font-size:12px; list-style:none;">▼ show all</summary>
                        <div style="margin-top:6px; padding:6px 10px; background:#fff0f0; border:1px solid #f5c6cb; border-radius:3px; font-size:12px; line-height:1.8;">
            ...
            <details style="margin-bottom: 8px; border: 1px solid #e0e0e0; border-radius: 4px;">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                    ...
                    <?php foreach ($diffs as $field => $vals):
                        $db_display   = esc_html(mb_strimwidth($vals['db'], 0, 120, '…'));
                        $file_display = esc_html(mb_strimwidth($vals['file'], 0, 120, '…'));
                    ...
                    ?>
                        <tr style="border-bottom: 1px solid #eee;">
                            ...
                            <td style="padding: 6px 10px; background: #fff0f0; word-break: break-word;"><?php echo $db_display; ?></td>
                            <td style="padding: 6px 10px; background: #f0fff0; word-break: break-word;"><?php echo $file_display; ?></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
