...
The {product_name} Team";
    ...
    public function register_settings() {
        ...
        // v1.7.3: Seed PayPal sandbox credentials if not set
        if (get_option('flosc_paypal_client_id') === false || get_option('flosc_paypal_client_id') === '') {
            update_option('flosc_paypal_client_id', 'Ac9vXbpAO30vY9QmbPDMy3tUkTapXTWMZ0qPP4N0MdSK7DPT0wDII-9urwbDTkTsEZg9RajgYRxNRzWg');
    ...
    public function enqueue_assets() {
        ...
        if ($paypal && $paypal->has_client_id()) {
            ...
            if ($pp_client_id) {
                wp_enqueue_script('paypal-js', 'https://www.paypal.com/sdk/js?client-id=' . urlencode($pp_client_id) . '&currency=USD&intent=capture&components=buttons', [], null, true);
            }
        }
    }
