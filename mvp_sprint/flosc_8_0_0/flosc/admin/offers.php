...
<details style="margin-top:30px;" open>
    ...
    <div style="margin-top:10px;padding:16px;background:#f9f9f9;border-radius:6px;">
        ...
        <div style="background:#fff;border:1px solid #e0e0e0;border-left:4px solid <?php echo $demo['color']; ?>;border-radius:5px;padding:14px 16px;display:flex;align-items:flex-start;justify-content:space-between;gap:16px;">
            <div style="flex:1;">
                <strong style="font-size:13px;"><?php echo $demo['emoji'] . ' ' . esc_html( $demo['title'] ); ?></strong>
