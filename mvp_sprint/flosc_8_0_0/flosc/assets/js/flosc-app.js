...
class floscApp {
    ...
    startIpaQuiz() {
        ...
        const phrases = [
            'Friendly Penny worried that fickle Fanny might marry her brother Bert',
            "There's different rules in rural America",
            'The world wide web says the big red rock is worth a visit to the theater',
            'Ruth searched the university library for thirty thoroughly boring authors',
            'Cousin sister brother mother father peanut butter'
        ];

        // Static IPA data — 3 rows per word
        // espeak: ~90% precision reference (auto-generated)
        // mw: Merriam-Webster IPA reference
        // da1ni5: scoring target — the source of 100% correctness
        const wordIpa = {
            // Phrase 1
            friendly:    { espeak: 'fɹɛndli',         mw: 'fɹɛndli',       da1ni5: ['fɹɛndli'] },
            penny:       { espeak: 'pɛni',            mw: 'pɛni',          da1ni5: ['pɛni'] },
            worried:     { espeak: 'wʌɹid',           mw: 'wɜːɹid',        da1ni5: ['wɜːɹid'] },
            that:        { espeak: 'ðæt',             mw: 'ðæt',           da1ni5: ['ðæt'] },
            fickle:      { espeak: 'fɪkəl',           mw: 'fɪkəl',         da1ni5: ['fɪkəl'] },
            fanny:       { espeak: 'fæni',            mw: 'fæni',          da1ni5: ['fæni'] },
            might:       { espeak: 'maɪt',            mw: 'maɪt',          da1ni5: ['maɪt'] },
            marry:       { espeak: 'mæɹi',            mw: 'mæɹi',          da1ni5: ['mæɹi'] },
            her:         { espeak: 'hɜːɹ',            mw: 'hɜːɹ',          da1ni5: ['hɜːɹ'] },
            brother:     { espeak: 'bɹʌðɚ',          mw: 'bɹʌðɚ',         da1ni5: ['bɹʌðɚ'] },
            bert:        { espeak: 'bɜːɹt',           mw: 'bɜːɹt',         da1ni5: ['bɜːɹt'] },
            // Phrase 2
            ...
            world:       { espeak: 'wɜːld',           mw: 'wɜːld',         da1ni5: ['wɜːld'] },
            wide:        { espeak: 'waɪd',            mw: 'waɪd',          da1ni5: ['waɪd'] },
            web:         { espeak: 'wɛb',             mw: 'wɛb',           da1ni5: ['wɛb'] },
            says:        { espeak: 'sɛz',             mw: 'sɛz',           da1ni5: ['sɛz'] },
            big:         { espeak: 'bɪɡ',             mw: 'bɪɡ',           da1ni5: ['bɪɡ'] },
            red:         { espeak: 'ɹɛd',             mw: 'ɹɛd',           da1ni5: ['ɹɛd'] },
            rock:        { espeak: 'ɹɑːk',            mw: 'ɹɑːk',          da1ni5: ['ɹɑːk'] },
            is:          { espeak: 'ɪz',              mw: 'ɪz',            da1ni5: ['ɪz'] },
            worth:       { espeak: 'wɜːɹθ',           mw: 'wɜːɹθ',         da1ni5: ['wɜːɹθ'] },
            a:           { espeak: 'ə',               mw: 'ə',             da1ni5: ['ə'] },
            visit:       { espeak: 'vɪzɪt',           mw: 'vɪzɪt',         da1ni5: ['vɪzɪt'] },
            to:          { espeak: 'tuː',             mw: 'tuː',           da1ni5: ['tuː'] },
            theater:     { espeak: 'θiːəɾɚ',          mw: 'θiːəɾɚ',        da1ni5: ['θiːəɾɚ'] },
            // Phrase 4
            ruth:        { espeak: 'ɹuːθ',            mw: 'ɹuːθ',          da1ni5: ['ɹuːθ'] },
            searched:    { espeak: 'sɜːɹtʃt',         mw: 'sɜːɹtʃt',       da1ni5: ['sɜːɹtʃt'] },
            university:  { espeak: 'juːnɪvɜːɹsɪɾi',  mw: 'juːnɪvɜːɹsɪɾi', da1ni5: ['juːnɪvɜːɹsɪɾi'] },
            library:     { espeak: 'laɪbɹɛɹi',        mw: 'laɪbɹɛɹi',      da1ni5: ['laɪbɹɛɹi'] },
            for:         { espeak: 'fɔːɹ',            mw: 'fɔːɹ',          da1ni5: ['fɔːɹ'] },
            thirty:      { espeak: 'θɜːɹɾi',          mw: 'θɜːɹɾi',        da1ni5: ['θɜːɹɾi'] },
            thoroughly:  { espeak: 'θɜːɹəli',         mw: 'θɜːɹəli',       da1ni5: ['θɜːɹəli'] },
            boring:      { espeak: 'bɔːɹɪŋ',          mw: 'bɔːɹɪŋ',        da1ni5: ['bɔːɹɪŋ'] },
            authors:     { espeak: 'ɑːθɚɹz',          mw: 'ɑːθɚɹz',        da1ni5: ['ɑːθɚɹz'] },
            // Phrase 5
        ...
        this.addMessage('assistant', 'Let\'s assess your Standard American English pronunciation. You\'ll read **5 phrases** aloud — one at a time. I\'ll analyze each sound you make.');
