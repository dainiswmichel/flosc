...
<table class="form-table">
    <tr>
        ...
        <td>
            <fieldset>
                <label style="display: block; margin-bottom: 12px; padding: 12px; border: 1px solid #c3c4c7; border-radius: 4px; cursor: pointer; <?php echo $flosc_content_display_mode === 'in_chat' ? 'background: #f0f6fc; border-color: #2271b1;' : ''; ?>">
                ...
                <label style="display: block; margin-bottom: 12px; padding: 12px; border: 1px solid #c3c4c7; border-radius: 4px; cursor: pointer; <?php echo $flosc_content_display_mode === 'companion' ? 'background: #f0f6fc; border-color: #2271b1;' : ''; ?>">
                ...
                <label style="display: block; margin-bottom: 12px; padding: 12px; border: 1px solid #c3c4c7; border-radius: 4px; cursor: pointer; <?php echo $flosc_content_display_mode === 'both' ? 'background: #f0f6fc; border-color: #2271b1;' : ''; ?>">
...
<div id="companion-widget-settings" style="<?php echo $flosc_content_display_mode === 'in_chat' ? 'opacity: 0.5; pointer-events: none;' : ''; ?>">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input type="color" name="flow_companion_accent_color" id="flow_companion_accent_color" value="<?php echo esc_attr($flosc_accent_color ?: '#6366f1'); ?>" style="width: 60px; height: 36px; padding: 2px; cursor: pointer;">
                <input type="text" id="companion_accent_hex" value="<?php echo esc_attr($flosc_accent_color ?: '#6366f1'); ?>" style="width: 100px; margin-left: 8px;" readonly>
...
<div style="background: #f8f9fa; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; position: relative; min-height: 200px; overflow: hidden;">
    <p style="color: #787c82; font-size: 13px; margin: 0;">
        📱 A floating <strong style="color: <?php echo esc_attr($flosc_accent_color ?: '#6366f1'); ?>;">●</strong> chat button will appear in the 
    ...
    <div style="position: absolute; bottom: 12px; <?php echo $flosc_position === 'bottom-left' ? 'left: 16px;' : 'right: 16px;'; ?>">
        <div style="width: 48px; height: 48px; border-radius: 50%; background: <?php echo esc_attr($flosc_accent_color ?: '#6366f1'); ?>; display: flex; align-items: center; justify-content: center; font-size: 22px; box-shadow: 0 4px 16px rgba(0,0,0,0.2);">
            💬
        </div>
    </div>
</div>
