 ...
 * v8.0.2: Michel Date Stamp Innovation format, encourage language
 */

// v8.0.4: Clear localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '8.0.4';
    try {
...
Purchased: ${ctx.purchased}
    ...
    async sendMessage() {
        ...
        if (this.onUserMessage(message)) {
            console.log('[FLOSC] onUserMessage handled the message, returning');
            return;
        }
