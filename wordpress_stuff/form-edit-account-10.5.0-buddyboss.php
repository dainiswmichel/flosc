	...
	<div class="wc-MyAccount-inner-content">
		<div class="woocommerce-account-fields">
			...
			<p class="woocommerce-account-fields__ctrls-wrapper">
				...
				<button type="submit" class="woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'buddyboss-theme' ); ?>"><?php esc_html_e( 'Save changes', 'buddyboss-theme' ); ?></button>
