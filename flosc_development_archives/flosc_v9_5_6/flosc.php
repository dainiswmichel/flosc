...
class FLOSC_Framework {
    ...
    private function init_hooks() {
        ...
        // Login redirect - send users to FLOSC app after login (v9.5.6)
...
The Team',
    ...
    /**
     * v9.5.6: Redirect users to FLOSC app after login
    ...
    /**
     * v9.5.6: Handle WooCommerce-specific login redirect
     */
