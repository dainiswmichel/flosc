...
$chat_scale  = intval(get_option('flosc_chat_style_scale', 111)); // percent
?>
        ...
        <div class="modal recording-modal">
            ...
            <div class="modal-body">
                <p class="recording-instructions" id="recordingInstructions">
                    ...
                    // For text-based or audio quiz, show the items
                    if (($quiz_type === 'flosc_sample_text_based_quiz' || $quiz_type === 'flosc_sample_audio_quiz') && !empty($quiz_content)) {
