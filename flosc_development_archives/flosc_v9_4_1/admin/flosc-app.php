...
<body class="flosc-app"
    ...
    <aside class="flosc-sidebar" id="flosc_app_sidebar">
        <div class="flosc-sidebar-header">
            <div class="flosc-sidebar-logo">
                <?php if (!empty($product['logo_url'])): ?>
                    <img src="<?php echo esc_url($product['logo_url']); ?>" alt="<?php echo esc_attr($product['name']); ?>" class="flosc-logo-img">
                <?php else: ?>
                    <span class="flosc-logo-emoji"><?php echo esc_html($product['emoji']); ?></span>
                <?php endif; ?>
                <span class="flosc-logo-text"><?php echo esc_html($product['name'] ?: 'FLOSC'); ?></span>
            </div>
            <div class="flosc-sidebar-actions">
                <button class="flosc-sidebar-action-btn" id="flosc_app_restart_chat" title="Restart chat" aria-label="Restart chat">
                ...
                <button class="flosc-sidebar-toggle" id="flosc_app_sidebar_toggle" aria-label="Close sidebar">
        ...
        <button class="flosc-new-chat-btn" id="flosc_app_new_session_button">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <!-- Session history -->
        <div class="flosc-session-list" id="flosc_app_session_list"></div>
        <?php endif; ?>

        <!-- User profile card -->
        <div class="flosc-user-profile" id="flosc_app_profile_card">
            <button class="flosc-profile-button" id="flosc_app_profile_button">
                <img src="" alt="" class="flosc-profile-avatar" id="flosc_app_profile_avatar">
                <div class="flosc-profile-info">
                    <div class="flosc-profile-name" id="flosc_app_profile_name"></div>
                    <div class="flosc-profile-badge" id="flosc_app_profile_badge"></div>
                </div>
                <svg class="flosc-dropdown-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
            </button>

            <div class="flosc-profile-dropdown" id="flosc_app_profile_dropdown">
                <div class="flosc-profile-dropdown-header">
                    <div class="flosc-dropdown-name" id="flosc_app_dropdown_name"></div>
                    <div class="flosc-dropdown-email" id="flosc_app_dropdown_email"></div>
                </div>
                <div class="flosc-upgrade-container" id="flosc_app_upgrade_container">
                    <button class="flosc-upgrade-btn" id="flosc_app_upgrade_button">
                ...
                <?php if (is_user_logged_in()): ?>
                    ...
                    ?>
                    <a href="<?php echo esc_url($profile_url); ?>" class="flosc-profile-dropdown-item">My Profile</a>
                    <?php if (current_user_can('read')): ?>
                        <a href="<?php echo admin_url(); ?>" class="flosc-profile-dropdown-item">Dashboard</a>
                    <?php endif; ?>
                <?php endif; ?>
                <a href="#" class="flosc-profile-dropdown-item" id="flosc_app_settings_link">Settings</a>
                <a href="#" class="flosc-profile-dropdown-item" id="flosc_app_help_link">Help</a>
                <a href="<?php echo wp_logout_url(home_url(get_option('flosc_app_slug', 'app'))); ?>" class="flosc-profile-dropdown-item">Log out</a>
            </div>
        </div>
    </aside>
    ...
    <main class="flosc-main">
        ...
        <header class="flosc-header">
            <div class="flosc-header-left">
                <button class="flosc-mobile-menu-btn" id="flosc_app_mobile_menu_button" aria-label="Open menu">
                ...
                <div class="flosc-logo-mobile">
                    <?php echo esc_html($product['emoji']); ?> <?php echo esc_html($product['name'] ?: 'FLOSC'); ?>
                </div>
            </div>

            <div class="flosc-header-right" id="flosc_app_header_right">
                <!-- Visitor: auth buttons -->
                <div class="flosc-auth-buttons" id="flosc_app_auth_buttons">
                    <a href="<?php echo esc_url(wp_login_url(home_url(get_option('flosc_app_slug', 'app')))); ?>" class="flosc-btn-secondary">Log in</a>
                    <a href="<?php echo esc_url(wp_registration_url()); ?>" class="flosc-btn-primary">Sign up</a>
                </div>
        ...
        <!-- Chat container -->
        <div class="flosc-chat-container" id="flosc_chat_container">
            <!-- Landing state -->
            <div class="flosc-landing-state" id="landingState">
                <h1 class="flosc-landing-title">Welcome to <?php echo esc_html($product['name'] ?: 'FLOSC'); ?></h1>
                <p class="flosc-landing-subtitle"><?php echo esc_html($product['tagline'] ?: 'Your AI-powered assistant'); ?></p>
            </div>
            ...
            <div class="flosc-messages" id="flosc_output_chat_responses">
                <!-- Greeting for logged in users -->
                <div class="flosc-greeting" id="greeting">
                    <h2 class="flosc-greeting-title" id="greetingTitle">Welcome back</h2>
                </div>
            </div>
            ...
            <!-- Typing indicator -->
            <div class="flosc-typing-indicator" id="flosc_output_chat_typing_indicator">
                <div class="flosc-typing-avatar"><?php echo esc_html($product['emoji']); ?></div>
                <div class="flosc-typing-dots">
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
        ...
        <!-- Composer -->
        <div class="flosc-input-composer" id="flosc_input_composer">
            <div class="flosc-input-composer-inner">
                <button class="flosc-input-voice-btn" id="flosc_input_chat_voice_button" aria-label="Record audio">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                ></textarea>
                <button class="flosc-input-send-btn" id="flosc_input_chat_send_button" aria-label="Send message">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
