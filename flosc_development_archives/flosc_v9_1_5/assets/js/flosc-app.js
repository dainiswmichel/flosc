 ...
 * v9.1.5: Skeleton content implementation - 10 placeholder lessons, quiz flow, complete funnel
 */

// v9.1.5: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.1.5';
    try {
        ...
        if (stored !== FLOSC_JS_VERSION) {
            ...
            console.log('FLOSC v9.1.5: Storage cleared - fresh session');
        }
    } catch(e) {
