 ...
 * 
 * BACKEND STATUS: Offer display functional, creation/editing UI ready, persistence needs wiring
 */
...
<div class="card" style="max-width: 100%; margin-bottom: 20px;">
    ...
    <?php if (empty($offers)): ?>
        <p style="color: #666; font-style: italic;">No offers configured yet. Create your first offer below.</p>
                    ...
                    <tr style="<?php echo !$is_active ? 'opacity: 0.6;' : ''; ?>">
                        <td>
                            ...
                            <?php if (!empty($offer['description'])): ?>
                                <br><small style="color: #666;"><?php echo esc_html(wp_trim_words($offer['description'], 10)); ?></small>
                            <?php endif; ?>
                        </td>
                        <td>
