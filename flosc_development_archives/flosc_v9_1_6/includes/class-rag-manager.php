...
class FLOSC_RAG_Manager {
    ...
    private function search_posts($keywords, $limit, $access_level) {
        ...
        // PSEUDOCODE: In future, filter by custom post type 'flosc_lesson'
        // For now, search all posts in a specific category
        
        $args = [
            's' => $keywords,
            'posts_per_page' => $limit,
            'post_status' => 'publish',
            // FUTURE: 'post_type' => 'flosc_lesson',
            // FUTURE: 'category_name' => 'flosc-lessons'
        ];
        ...
        foreach ($posts as $post) {
            ...
            // Get lesson number from meta (if exists)
