...
class FLOSC_Framework {
    ...
    private function load_dependencies() {
        ...
        require_once FLOSC_PLUGIN_DIR . 'includes/class-shortcode-handler.php'; // v9.2.0
...
The {product_name} Team";
    ...
    public function add_admin_menu() {
        ...
        // 10. IVR Editor (hidden page - accessed via "Edit Messages" button)
        add_submenu_page(
            null, // Hidden from menu (parent = null)
            'IVR Message Editor',
            'IVR Editor',
            'manage_options',
            'flosc-ivr',
            [$this, 'render_ivr_editor_page']
        );
    }
    ...
    public function render_ivr_editor_page() {
