...
The {product_name} Team";
    ...
    public function handle_app_route() {
        ...
        if ($ref && !is_user_logged_in()) {
            // v06.10: PHP 7.2 compatible setcookie (old syntax)
            setcookie(
                'flosc_referrer',
    ...
    /**
     * Sanitize app slug - strip leading/trailing slashes and whitespace
     * v06.11: Ensure consistent slug format
     */
    ...
    public function store_prelogin_score($request) {
        ...
        // v06.12: PHP 7.2 compatible setcookie (old syntax)
        setcookie(
