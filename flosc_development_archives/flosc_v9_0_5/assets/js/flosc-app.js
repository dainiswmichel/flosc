 ...
 * v9.0.4: Fixed first_show_session context, button handlers, simplified sendMessage flow
 */

// v9.0.4: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.0.4';
    try {
        ...
        if (stored !== FLOSC_JS_VERSION) {
            ...
            console.log('FLOSC v9.0.4: Storage cleared - fresh session');
        }
    } catch(e) {
