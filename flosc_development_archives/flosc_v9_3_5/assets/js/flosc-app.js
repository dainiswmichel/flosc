 ...
 * v9.3.5: Superlight styling, infinite carousel, PromptPanel rename, auto-scroll fix
 */

// v9.3.5: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.3.5';
    try {
...
class floscApp {
    ...
    showSuggestedReplies() {
        ...
        // v9.3.1: Show ALL autoprompts for current phase (carousel handles overflow)
        if (this.state === 'visitor') {
