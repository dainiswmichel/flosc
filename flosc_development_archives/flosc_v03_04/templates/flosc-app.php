...
<?php
// Determine if funnel is completed (for hiding sidebar)
$funnel_completed = is_user_logged_in() && get_user_meta(get_current_user_id(), '_flosc_funnel_completed', true);
$body_class = 'flosc-app';
if (!$funnel_completed) {
    $body_class .= ' flosc-funnel-incomplete';
}
?>
<body class="<?php echo esc_attr($body_class); ?>" data-user-state="<?php echo esc_attr($user_state); ?>">
