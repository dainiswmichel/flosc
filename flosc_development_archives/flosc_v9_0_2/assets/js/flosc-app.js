 ...
 * v9.0.2: Complete system working - visitor flow, guest flow, quiz, login, offers
 */

// v9.0.2: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.0.2';
    try {
        ...
        if (stored !== FLOSC_JS_VERSION) {
            ...
            console.log('FLOSC v9.0.2: Storage cleared - fresh session');
        }
    } catch(e) {
...
class floscApp {
    ...
    startIVR() {
        console.log('FLOSC v9.0.2: Starting IVR for phase:', this.ivr.phase);
