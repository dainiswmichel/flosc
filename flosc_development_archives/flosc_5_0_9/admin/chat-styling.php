...
<table class="form-table">
    ...
    <tr>
        ...
        <td>
            ...
            <p class="description">User message bubbles, send button, autoprompt hover, links, quiz active states. Sets <code>--flosc-accent</code>. Independent from Brand Color on Identity tab.</p>
