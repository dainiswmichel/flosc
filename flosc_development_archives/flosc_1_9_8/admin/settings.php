                        ...
                        <td>
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <input type="url" id="flow_chatlogo_url" name="flow_chatlogo_url" class="regular-text"
                                       value="<?php echo esc_attr($flow_settings['chatlogo_url'] ?? ''); ?>"
                                       placeholder="https://...">
                                <button type="button" class="button" id="flosc_upload_chatlogo">Choose Image</button>
                                <img src="<?php echo esc_url($flow_settings['chatlogo_url'] ?? ''); ?>" 
                                     alt="" id="flosc_chatlogo_preview"
                                     style="max-height: 40px; border-radius: 4px;<?php echo empty($flow_settings['chatlogo_url']) ? ' display: none;' : ''; ?>">
                            </div>
                        ...
                        <td>
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <input type="url" id="flow_favicon_url" name="flow_favicon_url" class="regular-text"
                                       value="<?php echo esc_attr($flow_settings['favicon_url'] ?? ''); ?>"
                                       placeholder="https://...">
                                <button type="button" class="button" id="flosc_upload_favicon">Choose Image</button>
                                <img src="<?php echo esc_url($flow_settings['favicon_url'] ?? ''); ?>" 
                                     alt="" id="flosc_favicon_preview"
                                     style="width: 32px; height: 32px; border-radius: 6px;<?php echo empty($flow_settings['favicon_url']) ? ' display: none;' : ''; ?>">
                            </div>
