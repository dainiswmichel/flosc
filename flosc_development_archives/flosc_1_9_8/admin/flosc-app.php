...
<head>
    ...
    <title><?php echo esc_html($identity['name'] ?: 'FLOSC App'); ?> - <?php echo esc_html($identity['tagline']); ?></title>
    
    <!-- v1.9.8: Favicon — uses per-flow favicon_url, falls back to bundled default -->
    <?php
        ...
        <div class="chat-container" id="flosc_chat_container">
            ...
            <div class="landing-state" id="landingState">
                <div class="landing-header">
                    ...
                    <span class="landing-subtitle"><?php echo esc_html($identity['tagline'] ?: 'Your AI-powered assistant'); ?></span>
                </div>
        ...
        <div class="flosc-modal flosc-payment-modal">
            ...
            <div class="flosc-modal-body">
                <div class="flosc-payment-summary">
                    <div class="flosc-payment-product">
                        ...
                        <div class="flosc-product-info">
                            <div class="flosc-product-name"><?php echo esc_html($identity['name'] ?: 'FLOSC'); ?> Full Access</div>
                            <div class="flosc-product-desc">Lifetime access to all content</div>
                        </div>
                    </div>
                    <div class="flosc-payment-price" id="paymentPrice"><?php echo esc_html($identity['currency_symbol'] . $identity['price']); ?></div>
                </div>
                ...
                <button class="flosc-pay-btn" id="payBtn" disabled>
                    <span class="flosc-pay-btn-text">Pay <?php echo esc_html($identity['currency_symbol'] . $identity['price']); ?></span>
