...
<div class="wrap flosc-ivr-admin">
    ...
    <div class="flosc-ivr-notice">
        <strong>Understanding FLOSC Phases (5 phases):</strong>
        <ul>
            <li><strong>F = Freeline:</strong> Visitor (not logged in) - Goal: Get them to take the quiz</li>
            <li><strong>L = Login:</strong> Post-quiz visitors + Logged-in users - Goal: Get account creation OR deliver free lesson and present offer</li>
            <li><strong>O = Offer:</strong> Sales pitch via chat - Goal: Get them to purchase</li>
            <li><strong>S = Sale:</strong> Post-purchase - Goal: Onboard to content</li>
            <li><strong>C = Content:</strong> Ongoing access - Goal: Support and encourage</li>
        </ul>
        <p><strong>Note:</strong> Login phase handles two sub-states: (1) Post-quiz visitors who need to create account, (2) Logged-in users ready for free lesson</p>
    </div>
    ...
    <form id="flosc-ivr-form" class="flosc-ivr-config">
        ...
        <div class="ivr-phase-section">
            <h2 class="ivr-phase-title">
                <span class="dashicons dashicons-arrow-down-alt2 ivr-toggle"></span>
                Login Phase (Post-Quiz + Logged-In)
            </h2>
            <div class="ivr-phase-content">
                <div class="ivr-message-group">
                    <h3>Initial Message</h3>
                    <p class="description">Message for post-quiz visitors (encourage account creation) AND logged-in users (welcome + deliver free lesson). Variables: {name}, {score}</p>
