 ...
 * Description: Freeline-Login-Offer-Sale-Content - A conversational sales funnel framework with multi-payment support
 * Version: 0.2.9
...
class FLOSC_Framework {
    ...
    public function register_settings() {
        ...
        // Quiz
        register_setting('flosc_settings', 'flosc_quiz_mode');
        register_setting('flosc_settings', 'flosc_quiz_expected');
        register_setting('flosc_settings', 'flosc_quiz_instructions');
