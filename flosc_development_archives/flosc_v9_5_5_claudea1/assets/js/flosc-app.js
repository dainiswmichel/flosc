...
class floscApp {
    ...
    renderSuggestedReplies(replies) {
        ...
        // v9.5.5: Check if any replies use card style - cards get carousel, pills get simple flex
        ...
        // v9.5.5: Conditional carousel or simple pill layout
