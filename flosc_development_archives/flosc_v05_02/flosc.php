...
The {product_name} Team";
    ...
    public function add_admin_menu() {
        ...
        // 1. Product Settings (tab shortcut)
        add_submenu_page(
            'flosc-settings',
            'Product Settings',
            'Product',
        ...
        // 2. IVR Messages - added by IVR_Manager, will appear here

        // 3. AI Configuration (existing page)
        add_submenu_page(
            'flosc-settings',
            'AI Configuration',
            'AI Configuration',
        ...
        // 6. AI Knowledge Files (existing page)
        add_submenu_page(
            'flosc-settings',
            'AI Knowledge Files',
            'AI Knowledge',
    ...
    /**
     * v05_02: Redirect handlers for tab shortcuts
     */
