...
The {product_name} Team";
    ...
    public function add_admin_menu() {
        ...
        // 3. IVR Messages - added by IVR_Manager, will appear here

        // 4. AI Configuration (existing page)
        add_submenu_page(
            'flosc-settings',
            'AI Configuration',
            'AI Configuration',
        ...
        // 7. AI Knowledge Files (existing page)
        add_submenu_page(
            'flosc-settings',
            'AI Knowledge Files',
            'AI Knowledge',
            'manage_options',
            'flosc-ai-knowledge',
            [$this, 'render_ai_orientation_page']
        );

        // 8. Offers (existing page)
        add_submenu_page(
            'flosc-settings',
            'Offers',
            'Offers',
    ...
    public function render_ai_orientation_page() {
        include FLOSC_PLUGIN_DIR . 'templates/admin/ai-orientation.php';
    }

    /**
     * Redirect handlers for tab shortcuts
     */
