        ...
        <div class="modal recording-modal">
            ...
            <div class="modal-body">
                <div class="recording-instructions" id="recordingInstructions">
                    <p>Please say the following clearly:</p>
                ...
                <div class="recording-visualizer" id="recordingVisualizer">
                    <div class="recording-status" id="recordingStatus">
                        <svg class="mic-icon" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="recording-controls">
                    ...
                    <button class="btn-play" id="playBtn" style="display: none;">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polygon points="5 3 19 12 5 21 5 3"></polygon>
                        </svg>
                        <span>Play Back</span>
                    </button>
                    <button class="btn-submit" id="submitRecordingBtn" style="display: none;">
                        <span>Analyze My Pronunciation</span>
                    </button>
                </div>
            </div>
        </div>
