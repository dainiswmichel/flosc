 ...
 * v9.0.1: Clean three-tier business logic - visitor/guest/member, proper quiz-login-lesson flow
 */

// v9.0.1: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.0.1';
    try {
        ...
        if (stored !== FLOSC_JS_VERSION) {
            ...
            console.log('FLOSC v9.0.1: Storage cleared - fresh session');
        }
    } catch(e) {
...
class floscApp {
    ...
    startIVR() {
        console.log('FLOSC v9.0.1: Starting IVR for phase:', this.ivr.phase);
