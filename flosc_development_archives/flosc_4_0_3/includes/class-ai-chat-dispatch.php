...
class FLOSC_AI_Chat_Dispatch {
    ...
    public function build_system_prompt($phase = '', $context = []) {
        ...
        if ( is_user_logged_in() && class_exists( 'FLOSC_LeSAEp_Pronunciation_Quiz' ) ) {
            ...
            $raw_answers = get_user_meta( $user_id, '_flosc_quiz_answers_lesaep_pronunciation', true );
            if ( ! empty( $raw_answers ) ) {
                $quiz    = new FLOSC_LeSAEp_Pronunciation_Quiz();
                $content = function_exists( 'flosc_get_setting' ) ? flosc_get_setting( 'quiz_content_lesaep_pronunciation', '' ) : '';
        ...
        if ( is_user_logged_in() && current_user_can( 'manage_options' ) ) {
            ...
            // Quizzes
            if ( function_exists( 'flosc_get_setting' ) && class_exists( 'FLOSC_Quiz_Type_Factory' ) ) {
