...
class FLOSC_Framework {
    ...
    private function init_hooks() {
        ...
        // Login redirect - send users to FLOSC app after login (v9.5.5)
...
The Team',
    ...
    /**
     * v9.5.5: Redirect users to FLOSC app after login
    ...
    /**
     * v9.5.5: Handle WooCommerce-specific login redirect
     */
