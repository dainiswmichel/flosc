...
<head>
    ...
    <!-- v1.9.7: Favicon — uses per-flow favicon (app_icon_url), falls back to bundled default -->
    <?php
...
<body class="flosc-app<?php echo is_admin_bar_showing() ? ' admin-bar' : ''; ?>"
    ...
    <aside class="flosc-sidebar" id="flosc_app_sidebar">
        <div class="sidebar-header">
            <div class="logo">
                <img src="<?php echo esc_url(flosc_get_logo_url()); ?>" alt="<?php echo esc_attr($product['name']); ?>" class="logo-img">
        ...
        <header class="flosc-header">
            <div class="header-left">
                ...
                <div class="logo-mobile">
                    <img src="<?php echo esc_url(flosc_get_logo_url()); ?>" alt="" style="width:36px;height:36px;object-fit:contain;">
                    <?php echo esc_html($product['name'] ?: 'FLOSC'); ?>
                </div>
            </div>
        ...
        <div class="chat-container" id="flosc_chat_container">
            ...
            <div class="landing-state" id="landingState">
                <div class="landing-header">
                    ...
                    $landing_logo = function_exists('flosc_get_logo_url') ? flosc_get_logo_url() : (FLOSC_PLUGIN_URL . 'assets/img/flosc-icon.png');
                    ?>
                ...
                <div class="flosc-payment-summary">
                    <div class="flosc-payment-product">
                        <?php if (!empty($product['logo_url'])): ?>
                            <img src="<?php echo esc_url($product['logo_url']); ?>" alt="" class="flosc-product-icon" style="width:40px;height:40px;object-fit:contain;">
                        <?php endif; ?>
