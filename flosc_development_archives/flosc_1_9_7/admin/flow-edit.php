        ...
        <?php if ($current_tab === 'identity' || $is_new): ?>
            ...
            <form method="post">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row"><label for="product_color">Brand Color</label></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="url" id="product_logo" name="product_logo" 
                                   ...
                                   class="large-text" 
                                   placeholder="https://...">
                            <p class="description">Image shown in the landing state header beside the product name. Wider/rectangular formats welcome.</p>
                        </td>
                    </tr>
                    
                    <tr>
                        <th scope="row"><label for="product_app_icon">Favicon</label></th>
                        <td>
