...
if (isset($_POST['flosc_save_flow']) && wp_verify_nonce($_POST['_wpnonce'], 'flosc_save_flow')) {
    ...
    $data = [
        ...
        'ivr_file' => sanitize_file_name($_POST['ivr_file'] ?? 'ivr.md'),
                        ...
                        <td>
                            <select id="ivr_file" name="ivr_file" class="regular-text">
                                <?php foreach ($ivr_files as $file): ?>
                                    <option value="<?php echo esc_attr($file); ?>" <?php selected($flow['ivr_file'] ?? 'ivr.md', $file); ?>>
                            ...
                            <p class="description">
                                ...
                                To create a new IVR file for this flow, create a folder (e.g., <code>myflow/</code>) with an <code>ivr.md</code> file inside.
                            </p>
                        </td>
                    </tr>
                </table>
