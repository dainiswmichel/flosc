...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['orientation_file']) && !empty($_FILES['orientation_file']['name'])) {
        ...
        if (pathinfo($filename, PATHINFO_EXTENSION) !== 'md') {
            ...
            $upload_path = FLOSC_PLUGIN_DIR . 'ai_orientation_files/' . $filename;
    ...
    if (isset($_POST['create_file']) && !empty($_POST['new_filename']) && !empty($_POST['new_file_content'])) {
        ...
        $filepath = FLOSC_PLUGIN_DIR . 'ai_orientation_files/' . $filename;
...
if (isset($_GET['edit'])) {
    ...
    $filepath = FLOSC_PLUGIN_DIR . 'ai_orientation_files/' . $editing_file;
    if (file_exists($filepath)) {
...
<div class="wrap">
    ...
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        ...
        <form method="post">
            ...
            <p style="margin-top: 10px;">
                ...
                <a href="<?php echo admin_url('admin.php?page=flosc-ai-orientation'); ?>" class="button">Cancel</a>
            </p>
        </form>
    </div>
    <?php endif; ?>
    ...
    <div class="card" style="max-width: 800px;">
        ...
        <?php if (empty($files)): ?>
            <p>No orientation files yet. Upload or create your first file above.</p>
        <?php else: ?>
            <table class="widefat" style="margin-top: 10px;">
                ...
                <tbody>
                    <?php foreach ($files as $file): ?>
                        <?php
                        $filepath = FLOSC_PLUGIN_DIR . 'ai_orientation_files/' . $file;
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo admin_url('admin.php?page=flosc-ai-orientation&edit=' . urlencode($file)); ?>" class="button button-small">Edit</a>
