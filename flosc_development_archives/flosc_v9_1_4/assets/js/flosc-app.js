 ...
 * v9.1.4: Stability release - deprecated legacy code, input sanitization, AI integration readiness
 */

// v9.1.4: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.1.4';
    try {
        ...
        if (stored !== FLOSC_JS_VERSION) {
            ...
            console.log('FLOSC v9.1.1: Storage cleared - fresh session');
        }
    } catch(e) {
