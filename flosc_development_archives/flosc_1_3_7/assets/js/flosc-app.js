 ...
 * v1.3.7: Flow-aware API calls - sends flowId/ivrFile with requests
 */

// v9.4.7: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '1.3.1';
    try {
...
class floscApp {
    ...
    // ============================================
    // FLOSC SANDBOX PAYMENT v1.3.1
    // Fun "Pay What You Want" for testing
    // ============================================
    
    showSandboxPayment(offerId = 'sandbox') {
        const sandboxHtml = `
            <div class="flosc-sandbox-payment" data-offer-id="${offerId}">
                <h3>🎮 Sandbox Payment</h3>
                <p>Test the full purchase flow! Enter any amount you want.</p>
                ...
                <button class="flosc-sandbox-pay-btn" onclick="window.floscAppInstance.processSandboxPayment('${offerId}')">
                    🎉 Complete Fake Purchase
                </button>
                <p style="font-size: 12px; opacity: 0.8; margin-top: 10px;">
                    This grants <strong>flosc_sandbox</strong> membership level
                </p>
            </div>
        `;
    ...
    async processSandboxPayment(offerId) {
        ...
        try {
            // Call server to grant sandbox access
            ...
            if (result.success) {
                // Show success with fun amount
                const successHtml = `
                    <div class="flosc-sandbox-success">
                        <h3>🎉 Congratulations!</h3>
                        <p>Your sandbox purchase was successful!</p>
                        <div class="amount">${formattedAmount}</div>
                        <p style="opacity: 0.9;">You now have <strong>flosc_sandbox</strong> membership!</p>
                ...
                // Update user state
                this.state = 'member';
                this.user.memberLevel = 'flosc_sandbox';
