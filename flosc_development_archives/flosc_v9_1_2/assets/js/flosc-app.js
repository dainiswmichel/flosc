 ...
 * v9.1.0: Settings separation of concerns, modular admin architecture
 */

// v9.1.0: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.1.0';
    try {
        ...
        if (stored !== FLOSC_JS_VERSION) {
            ...
            console.log('FLOSC v9.0.6: Storage cleared - fresh session');
        }
    } catch(e) {
