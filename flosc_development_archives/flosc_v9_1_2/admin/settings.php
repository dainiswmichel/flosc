...
// Tabs that use the WordPress Settings API (options.php) form wrapper.
// Tabs that manage files / custom actions render their own forms.
...
$use_options_form = in_array($active_tab, $tabs_with_options_form, true);
?>
