...
function flosc_activate() {
    ...
    // v5.0.8 FIX: Must require the class files here because flosc_activate() runs
    // before the FLOSC class constructor (which normally loads these via class-sale-manager).
    // Without these requires, FLOSC_PayPal_Provider is undefined → fatal error on activation.
