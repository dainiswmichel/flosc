...
class FLOSC_Framework {
    ...
    private function load_dependencies() {
        ...
        require_once FLOSC_PLUGIN_DIR . 'includes/class-access-validator.php';
        require_once FLOSC_PLUGIN_DIR . 'includes/class-sample-data.php'; // v9.1.7
...
The {product_name} Team";
    ...
    public function render_sample_data_page() {
        include FLOSC_PLUGIN_DIR . 'admin/sample-data-manager.php';
    }
