...
<head>
    ...
    <!-- v05_08: DOMPurify for XSS protection -->
...
<body class="flosc-app" data-user-state="<?php echo esc_attr($user_state); ?>">
    ...
    <main class="flosc-main">
        ...
        <div class="chat-container" id="chatContainer">
            ...
            <!-- IntroPanel with close button (v3.0.8) - persists independently -->
            <div class="intro-panel" id="introPanel">
                <button class="intro-panel-close" id="introPanelClose" aria-label="Close IntroPanel">
                ...
                <div class="suggested-prompts">
                    <button class="prompt-card" data-action="get-started">
                        <span class="prompt-icon">🎤</span>
                        <span class="prompt-text">Get started</span>
                    </button>
                    <button class="prompt-card" data-action="start-quiz">
                        <span class="prompt-icon">📝</span>
                        <span class="prompt-text">Start free quiz</span>
                    </button>
                    <button class="prompt-card" data-action="how-it-works">
                        <span class="prompt-icon">❓</span>
                        <span class="prompt-text">How does it work?</span>
                    </button>
                    <button class="prompt-card" data-action="what-you-learn">
                        <span class="prompt-icon">📚</span>
    ...
    <script>
        window.FLOSC_CONFIG = <?php echo wp_json_encode([
            ...
            'messages' => [
                'welcome' => get_option('flosc_welcome_message', ''),
            ...
            // v04_03: IVR configuration
            'ivr' => FLOSC_IVR_Manager::get_instance()->get_frontend_config(),
        ]); ?>;
