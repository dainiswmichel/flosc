...
## Panel Targeting (v1.0.1)
MessagePanel: intro | prompt

**Panel Types:**
- `intro` → Appears in IntroPanel (visitors only)
- `prompt` → Appears in PromptPanel (guests and members)
...
**Business Rules:**
1. Never mix pills and cards in one panel
2. Single row only - overflow triggers carousel
3. Panel-level style should be consistent
