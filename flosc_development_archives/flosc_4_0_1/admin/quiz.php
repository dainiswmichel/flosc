...
$quiz_variants = $flow_settings['quiz_variants'] ?? ['A' => ['enabled' => true, 'condition' => '']];
$rotation_mode = $flow_settings['quiz_rotation_mode'] ?? 'progressive'; // 'progressive', 'random', 'sequential'

$active_quiz_type_id = $flow_settings['quiz_type'] ?? 'flosc_sample_text_based_quiz';
...
<div class="flosc-quiz-config">
    ...
    <div class="flosc-section-header">
        ...
        <p>Enable quizzes to power the FLOSC flow: Quiz &rarr; Score &rarr; Login Gate &rarr; Content &rarr; Sale</p>
    </div>
    ...
    <div class="flosc-quiz-grid">
        <!-- LeSAEp Pronunciation Assessment -->
        <div class="flosc-quiz-card <?php echo in_array('lesaep_pronunciation', $enabled_quizzes) ? 'active' : ''; ?>">
            <h4>
                <span class="icon">🎤</span>
                LeSAEp Pronunciation Assessment
                <span class="badge native">NATIVE</span>
            </h4>
            <p class="desc">10-question accent quiz identifying which American English sounds each learner needs to focus on first. Maps directly to LeSAEp lessons. Questions are editable in the Quiz Content section below.</p>
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_enabled_quizzes[]" value="lesaep_pronunciation" <?php checked(in_array('lesaep_pronunciation', $enabled_quizzes)); ?>>
                <label>Enabled</label>
            </div>
        </div>
        ...
        <div class="flosc-quiz-card <?php echo in_array('flosc_sample_text_based_quiz', $enabled_quizzes) ? 'active' : ''; ?>">
            ...
            <p class="desc">Type the sequence: 1, 2, 3... 10. Perfect for testing the full FLOSC flow.</p>
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_enabled_quizzes[]" value="flosc_sample_text_based_quiz" <?php checked(in_array('flosc_sample_text_based_quiz', $enabled_quizzes)); ?>>
                <label>Enabled</label>
            </div>
        </div>
        ...
        <div class="flosc-quiz-card <?php echo in_array('flosc_sample_audio_quiz', $enabled_quizzes) ? 'active' : ''; ?>">
            ...
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_enabled_quizzes[]" value="flosc_sample_audio_quiz" <?php checked(in_array('flosc_sample_audio_quiz', $enabled_quizzes)); ?>>
                <label>Enabled</label>
            </div>
        </div>
        ...
        <div class="flosc-quiz-card <?php echo in_array('multiplechoice', $enabled_quizzes) ? 'active' : ''; ?>">
            ...
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_enabled_quizzes[]" value="multiplechoice" <?php checked(in_array('multiplechoice', $enabled_quizzes)); ?>>
                <label>Enabled</label>
            </div>
        </div>
        ...
        <div class="flosc-quiz-card <?php echo in_array('truefalse', $enabled_quizzes) ? 'active' : ''; ?>">
            ...
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_enabled_quizzes[]" value="truefalse" <?php checked(in_array('truefalse', $enabled_quizzes)); ?>>
                <label>Enabled</label>
            </div>
        </div>
    </div>
    ...
    <p>FLOSC can capture scores from popular WordPress quiz plugins and use them in the flow.</p>
    ...
    <div class="flosc-quiz-grid">
        ...
        <div class="flosc-quiz-card">
            ...
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_wpq_integration" value="1" <?php checked($flow_settings['wpq_integration'] ?? 0); ?> <?php echo $detected_plugins['wp_pro_quiz']['status'] !== 'active' ? 'disabled' : ''; ?>>
        ...
        <div class="flosc-quiz-card">
            ...
            <p class="desc">Premium LMS with robust quizzes. FLOSC captures completion for flow progression.</p>
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_ld_integration" value="1" <?php checked($flow_settings['ld_integration'] ?? 0); ?> <?php echo $detected_plugins['learndash']['status'] !== 'active' ? 'disabled' : ''; ?>>
                <label>Enable Integration</label>
            </div>
        </div>
        ...
        <div class="flosc-quiz-card">
            ...
            <div class="flosc-quiz-toggle">
                <input type="checkbox" name="flow_qsm_integration" value="1" <?php checked($flow_settings['qsm_integration'] ?? 0); ?> <?php echo $detected_plugins['qsm']['status'] !== 'active' ? 'disabled' : ''; ?>>
                <label>Enable Integration</label>
            </div>
        </div>
    </div>
    ...
    <table class="form-table">
        <tr>
            <th scope="row"><label for="flow_quiz_type">Quiz Type</label></th>
            <td>
                <select name="flow_quiz_type" id="flow_quiz_type" class="regular-text">
        ...
        <tr>
            <th scope="row"><label for="flow_quiz_content_<?php echo esc_attr($active_quiz_type_id); ?>">Quiz Content</label></th>
            <td>
                <textarea
                    id="flow_quiz_content_<?php echo esc_attr($active_quiz_type_id); ?>"
                    name="flow_quiz_content_<?php echo esc_attr($active_quiz_type_id); ?>"
                    rows="8"
                    class="large-text code"
                    placeholder="<?php echo esc_attr($active_quiz_type->get_default_content()); ?>"
                ><?php echo esc_textarea($flow_settings['quiz_content_' . $active_quiz_type_id] ?? $active_quiz_type->get_default_content()); ?></textarea>
                <p class="description">
        ...
        <tr>
            <th scope="row"><label for="flow_quiz_rotation_mode">Rotation Mode</label></th>
            <td>
                <select name="flow_quiz_rotation_mode" id="flow_quiz_rotation_mode">
                ...
                <div style="background: #f0f0f1; padding: 10px; margin-top: 10px; font-family: monospace; font-size: 12px;">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;$flow_key = $GLOBALS['flosc_settings_key'] ?? '';<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;$fs = get_option($flow_key, []);<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;$visitor_count = $flow_settings['total_quiz_visitors'] ?? 0;<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;$fs['total_quiz_visitors'] = $visitor_count + 1;<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;update_option($flow_key, $fs);<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;<br>
                ...
                <table style="width: 100%; border: 1px solid #ddd; margin-top: 15px;">
                    ...
                    <tbody>
                        ...
                        foreach ($variant_letters as $letter):
                            ...
                            $variant_enabled = $flow_settings['quiz_variant_' . $letter . '_enabled'] ?? ($letter === 'A');
                            $variant_condition = $flow_settings['quiz_variant_' . $letter . '_freeline_condition'] ?? '';
                        ?>
                        <tr>
                            ...
                            <td style="padding: 10px; border-top: 1px solid #ddd;">
                                <input 
                                    type="checkbox" 
                                    name="flow_quiz_variant_<?php echo $letter; ?>_enabled" 
                                    value="1" 
                            ...
                            <td style="padding: 10px; border-top: 1px solid #ddd;">
                                <input 
                                    type="text" 
                                    name="flow_quiz_variant_<?php echo $letter; ?>_freeline_condition" 
        ...
        <?php foreach ($variant_letters as $letter): 
            $variant_enabled = $flow_settings['quiz_variant_' . $letter . '_enabled'] ?? ($letter === 'A');
            $variant_content = $flow_settings['quiz_content_variant_' . $letter] ?? $active_quiz_type->get_default_content();
        ?>
        <tr id="quiz-content-<?php echo $letter; ?>" style="<?php echo !$variant_enabled ? 'opacity: 0.5;' : ''; ?>">
            <th scope="row">
                <label for="flow_quiz_content_variant_<?php echo $letter; ?>">
            ...
            <td>
                <textarea
                    id="flow_quiz_content_variant_<?php echo $letter; ?>"
                    name="flow_quiz_content_variant_<?php echo $letter; ?>"
                    rows="8"
                    class="large-text code"
                    placeholder="<?php echo esc_attr($active_quiz_type->get_default_content()); ?>"
        ...
        ?>
            ...
            <?php foreach ($settings_fields as $field_key => $field_config):
                $field_storage_key = 'quiz_' . $active_quiz_type_id . '_' . $field_key;
                $field_name = 'flow_' . $field_storage_key;
                $field_value = $flow_settings[$field_storage_key] ?? ($field_config['default'] ?? '');
            ?>
                <tr>
        ...
        <?php foreach ($templates as $template_key => $default_template):
            $template_storage_key = 'quiz_' . $active_quiz_type_id . '_template_' . $template_key;
            $template_name = 'flow_' . $template_storage_key;
            $template_value = $flow_settings[$template_storage_key] ?? $default_template;
        ?>
            <tr>
