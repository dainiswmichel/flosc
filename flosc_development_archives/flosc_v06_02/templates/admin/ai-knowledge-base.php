    ...
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        ...
        <form method="post">
            ...
            <p style="margin-top: 10px;">
                ...
                <a href="<?php echo admin_url('admin.php?page=flosc-ai-configuration'); ?>" class="button">Cancel</a>
            </p>
        </form>
    </div>
    <?php endif; ?>
                ...
                <tbody>
                    <?php foreach ($files as $file): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo admin_url('admin.php?page=flosc-ai-configuration&edit=' . urlencode($file)); ?>" class="button button-small">Edit</a>
