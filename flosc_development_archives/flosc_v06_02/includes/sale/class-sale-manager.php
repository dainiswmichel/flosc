...
class FLOSC_Sale_Manager {
    ...
    private function load_components() {
        ...
        require_once __DIR__ . '/providers/class-clickbank-provider.php'; // v05_09
    ...
    private function register_providers() {
        ...
        $this->providers['clickbank'] = new FLOSC_ClickBank_Provider(); // v05_09
    ...
    public function process_purchase($user_id, $offer_id, $provider_id, $payment_data = []) {
        ...
        do_action('flosc_purchase_completed', $user_id, $offer_id, $provider_id, $result);
