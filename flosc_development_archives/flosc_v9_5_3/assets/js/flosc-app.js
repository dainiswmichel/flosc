...
class floscApp {
    ...
    showSuggestedReplies() {
        ...
        // v9.5.3: Fallback for visitors
        if (applicable.length === 0 && this.state === 'visitor') {
            console.log('FLOSC: Using visitor fallback replies');
            applicable.push(
                {
                    name: 'fallback_help',
        ...
        // v9.5.3: Fallback for logged-in users (guest/member)
        if (applicable.length === 0 && this.state !== 'visitor') {
            console.log('FLOSC: Using logged-in user fallback replies');
            applicable.push(
                {
                    name: 'fallback_continue',
                    user_input: '📚 Continue learning',
                ...
                },
                {
                    ...
                    content: 'Take a quick quiz to discover your pronunciation strengths!',
                    style: 'pill'
                },
                {
                    name: 'fallback_help_user',
                    user_input: '❓ How does it work?',
                    content: 'I can help you improve your pronunciation!',
                    style: 'pill'
                }
