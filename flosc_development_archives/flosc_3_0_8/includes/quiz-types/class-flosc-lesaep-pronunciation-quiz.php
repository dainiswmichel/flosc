...
class FLOSC_LeSAEp_Pronunciation_Quiz extends FLOSC_Abstract_Quiz_Type {
    ...
    public function get_instructions() {
        return 'Choose the best answer for each question. Your results will identify exactly which American English sounds to focus on first.';
    }

    /**
     * Default content is unused for this quiz type — questions are hardcoded
     * (stored in get_default_questions()) so no admin content field is needed.
     */
