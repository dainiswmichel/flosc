...
## 🆕 What's New in v9.4.5

### 🔧 Critical Fix
- **Flush Permalinks button** — Fixed "link expired" error caused by nested form issue
- Now uses WordPress `admin-post.php` handler with proper redirect
- Button appears in 2 locations: App Status card and Maintenance Tools
- Works reliably in all contexts

### ✅ Includes All Previous Fixes
- v9.4.3: Modal CSS restored
- v9.4.2: Security hardening (signed cookies, rate limiting)
...
## v9.4.2 - Security Hardening Release
