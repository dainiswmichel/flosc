...
class FLOSC_Framework {
    ...
    private function init_hooks() {
        ...
        // v9.4.4: Admin-post handler for flush permalinks (fixes nested form issue)
        add_action('admin_post_flosc_flush_permalinks', [$this, 'handle_admin_flush_permalinks']);
...
The {product_name} Team";
    ...
    /**
     * v9.4.4: Handle admin-post flush permalinks action
     * 
     * This is used instead of a nested form in product.php because
     * WordPress settings pages wrap tabs in a form that posts to options.php,
     * making nested forms invalid HTML that browsers ignore.
     */
    public function handle_admin_flush_permalinks() {
        // Verify nonce
        if (!isset($_GET['_wpnonce']) || !wp_verify_nonce($_GET['_wpnonce'], 'flosc_flush_permalinks')) {
        ...
        wp_safe_redirect(admin_url('admin.php?page=flosc-settings&tab=product&flosc_flushed=1'));
        exit;
    }
