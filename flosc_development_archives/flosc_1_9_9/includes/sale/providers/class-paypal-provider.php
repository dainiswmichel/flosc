...
class FLOSC_PayPal_Provider extends FLOSC_Payment_Provider {
    ...
    public function capture_order($order_id) {
        ...
        // v1.7.7: Forward PayPal's structured error details (especially INSTRUMENT_DECLINED)
        // so the JS frontend can call actions.restart() per PayPal's official pattern
        if ($status_code < 200 || $status_code >= 300) {
