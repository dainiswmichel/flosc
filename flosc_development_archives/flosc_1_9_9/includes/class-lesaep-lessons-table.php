...
class FLOSC_Lesaep_Lessons_Table {
    ...
    public function ensure_table() {
        ...
        if (defined('FLOSC_DEBUG') && FLOSC_DEBUG) {
            error_log('[FLOSC LESAEP] Lessons table ensured: ' . $this->table_name);
        }
    }
    ...
    public function get_lesson_by_number($lesson_number) {
        ...
        return $wpdb->get_row(
            $wpdb->prepare(
                "SELECT * FROM {$this->table_name} WHERE lesson_number = %s",
                $lesson_number
            ),
            ARRAY_A
        );
    ...
    public function get_lessons_by_category($category) {
        ...
        return $wpdb->get_results(
            $wpdb->prepare(
                "SELECT * FROM {$this->table_name} WHERE sound_category = %s ORDER BY sort_order ASC",
                $category
            ),
            ARRAY_A
        );
