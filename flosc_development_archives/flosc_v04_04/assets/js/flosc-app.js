...
class floscApp {
    ...
    /**
     * Handle prompt card actions (v04_02: Fixed to show user message, then bot responds)
     */
    async handlePromptCardAction(action) {
        switch(action) {
            case 'get-started':
                // v04_02: Add user message, then show typing, then bot responds
            ...
            case 'how-it-works':
                ...
                if (FLOSC_CONFIG.messages.howItWorks) {
                    this.addMessage('assistant', FLOSC_CONFIG.messages.howItWorks);
                }
                break;

            case 'what-you-learn':
                // v04_02: Add user message, then show typing, then bot responds
                this.addMessage('user', 'What will I learn?');
                this.showMessages();
                this.hideIntroPanel();
                ...
                if (FLOSC_CONFIG.messages.whatYouLearn) {
                    this.addMessage('assistant', FLOSC_CONFIG.messages.whatYouLearn);
                }
                break;
