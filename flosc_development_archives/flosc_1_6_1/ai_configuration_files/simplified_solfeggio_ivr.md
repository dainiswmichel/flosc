...
## What Will I Learn - Solfeggio
MessageName: solfeggio_learn_what
MessageType: suggested_user_autoprompt
MessageStyle: feature
Icon: 🎯
UserInput: What will I learn?
MessageContent: 🎵 **You'll learn Simplified Solfeggio** - the modern solution to a 1000-year-old riddle about how to teach, learn, write, and play music! The Michel Hand of Music puts the piano, the clock, and all of music theory onto one hand. Sight-sing in any key, understand any chord, and unlock the secrets medieval monks used to memorize entire liturgies!
MessageConditions: always
...
MessageName: sandbox_purchase_solfeggio
MessageType: suggested_user_autoprompt
MessageStyle: button
Icon: 🎮
UserInput: Test purchase (sandbox)
Action: sandbox_purchase_simplified_solfeggio
MessageContent: Opening sandbox purchase for Simplified Solfeggio - test the full flow with fake money!
MessageConditions: !is_member
