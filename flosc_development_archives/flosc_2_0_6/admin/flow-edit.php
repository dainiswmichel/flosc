...
if (isset($_POST['flosc_save_flow']) && wp_verify_nonce($_POST['_wpnonce'], 'flosc_save_flow')) {
    ...
    $data = [
        ...
        'identity' => [
            'name' => sanitize_text_field($_POST['floscflow_name'] ?? ''),
            'tagline' => sanitize_text_field($_POST['floscflow_tagline'] ?? ''),
            'chatlogo_url' => esc_url_raw($_POST['floscflow_chatlogo'] ?? ''),
            'favicon_url' => esc_url_raw($_POST['floscflow_favicon'] ?? ''),
            'badgeUrl' => esc_url_raw($_POST['floscflow_badge'] ?? ''),
            'primary_color' => sanitize_hex_color($_POST['floscflow_color'] ?? '#4f46e5'),
            'share_text' => sanitize_text_field($_POST['floscflow_share_text'] ?? ''),
        ],
