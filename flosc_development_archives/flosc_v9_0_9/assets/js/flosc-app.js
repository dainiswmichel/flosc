 ...
 * v9.0.6: Version alignment, session restore logic, resilient replies, expanded conditions
 */

// v9.0.6: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '9.0.6';
    try {
