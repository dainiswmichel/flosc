...
The {product_name} Team";
    ...
    public function add_admin_menu() {
        ...
        // 3. Chat Styling (standalone page)
        add_submenu_page(
            'flosc-settings',
            'Chat Styling',
            'Chat Styling',
    ...
    public function render_ai_knowledge_base_page() {
        include FLOSC_PLUGIN_DIR . 'templates/admin/ai-knowledge-base.php';
    }

    public function render_chat_style_page() {
        include FLOSC_PLUGIN_DIR . 'templates/admin/chat-style.php';
    }
