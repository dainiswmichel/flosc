...
MessageConditions: is_guest && offer_dismissed_oto_main && session_minutes >= 3
...
DisplayFormat: pill
Action: show_offer_oto_main
MessageContent: I want to see the current offer!
MessageConditions: is_guest && !offer_shown_oto_main
...
MessageConditions: is_guest && offer_shown_oto_main && message_count >= 5
...
MessageConditions: is_guest && offer_shown_oto_main && session_minutes >= 1
...
MessageConditions: is_guest && offer_shown_oto_main && message_count >= 4

## Exit Intent (Offer)
MessageName: oto_exit_001
MessageType: auto
MessageContent: Before you go - this special price won't last. Ready to start today?
MessageConditions: is_guest && offer_shown_oto_main && inactive_seconds > 180
