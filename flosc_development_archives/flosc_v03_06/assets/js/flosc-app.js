...
class FloscApp {
    ...
    handlePromptCardAction(action) {
        switch(action) {
            case 'get-started':
                // Show "Get Started" message from backend (with fallback for v3.0.6)
            ...
            case 'how-it-works':
                // Show "How It Works" message from backend (with fallback for v3.0.6)
                const howItWorksMsg = FLOSC_CONFIG.messages.howItWorks ||
                ...
                this.addBotMessage(howItWorksMsg);
                this.showMessages();
                break;

            case 'what-you-learn':
                // Show "What You Learn" message from backend (with fallback for v3.0.6)
                const whatYouLearnMsg = FLOSC_CONFIG.messages.whatYouLearn ||
                ...
                this.addBotMessage(whatYouLearnMsg);
                this.showMessages();
                break;
