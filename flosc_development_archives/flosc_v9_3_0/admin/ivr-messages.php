<?php
/**
 * FLOSC IVR Messages Tab - Full CRUD Editor (v9.3.0)
 * 
...
function flosc_run_ivr_diagnostics() {
    ...
    // v9.3.0: Michel Timestamp format for last checked
    ...
    if (is_wp_error($api_response)) {
        ...
        if (isset($data['success']) && $data['success'] && !empty($data['messages'])) {
            ...
            // v9.3.0: API works but 0 messages is still green (API is functional)
            $diagnostics['api_endpoint'] = [
                'status' => 'green',
...
// v9.2.10: Get list of available IVR files
...
<div class="flosc-diagnostics-panel" style="background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
    <h3 style="margin-top: 0; display: flex; align-items: center; gap: 10px;">
        🔧 IVR System Status
        <span style="font-size: 12px; font-weight: normal; color: #666;">(v9.2.10)</span>
    </h3>
    ...
    <div style="background: #e7f3ff; border: 1px solid #b3d7ff; border-radius: 6px; padding: 15px; margin-bottom: 20px;">
        <div style="margin-bottom: 15px;">
            <label style="font-weight: 600; display: block; margin-bottom: 8px;">
                📁 Active IVR Messages MD file:
            </label>
            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                <form method="post" style="display: flex; align-items: center; gap: 10px;">
                    <?php wp_nonce_field('flosc_change_active_file'); ?>
                    <select name="ivr_file_select" style="padding: 8px 12px; border-radius: 4px; border: 1px solid #ccc; min-width: 200px;">
                    ...
                    <button type="submit" name="flosc_change_active_file" class="button button-secondary">
                        Set as Active
                    </button>
                </form>
