        ...
        <?php if ($active_tab === 'identity'): ?>
            ...
            <div style="max-width: 1000px;">
                ...
                <?php foreach ($all_flows as $ivr_file => $flow_data): 
                    ...
                    $default_slug = sanitize_title(pathinfo($ivr_file, PATHINFO_FILENAME));
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        ...
                        <div>
                            <div style="margin-bottom: 15px;">
                                ...
                                <div style="display: flex; align-items: center; gap: 5px;">
                                    ...
                                    <input type="text" name="<?php echo $prefix; ?>slug" 
                                           ...
                                           placeholder="myapp"
                                           style="width: 150px; padding: 8px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-weight: 600;">
                            ...
                            <div style="margin-bottom: 15px;">
                                ...
                                <p style="font-size: 11px; color: #6b7280; margin: 4px 0 0;">Custom domain pointing to this flow (optional - for DNS setup reference)</p>
                            </div>
                ...
                <div style="background: #f0f9ff; border: 1px solid #0284c7; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                    <h4 style="margin: 0 0 10px; color: #0369a1; font-size: 14px;">🌐 Custom Domain DNS Setup</h4>
                    <p style="font-size: 13px; color: #0c4a6e; margin: 0 0 10px;">To use a custom domain (like flosc.ai or lesaep.com) for your FLOSC flow:</p>
                    <ol style="font-size: 12px; color: #0c4a6e; margin: 0; padding-left: 20px;">
                        <li>Add a CNAME record pointing your domain to: <code style="background: white; padding: 2px 6px; border-radius: 3px;"><?php echo esc_html(parse_url(home_url(), PHP_URL_HOST)); ?></code></li>
                        <li>Or add an A record pointing to your server's IP address</li>
                        <li>Configure your web server to handle the domain</li>
                        <li>Enter the domain in the "Custom Domain" field above</li>
                    </ol>
                    <p style="font-size: 11px; color: #64748b; margin: 10px 0 0;">
                        <a href="https://flosc.ai/docs/dns" target="_blank" style="color: #0284c7;">📚 Full DNS Configuration Guide</a> · 
                        <a href="https://flosc.ai/docs/setup" target="_blank" style="color: #0284c7;">📖 FLOSC Setup Guide</a>
                    </p>
                </div>
            ...
            <div class="card" style="max-width: 900px; padding: 20px; margin-top: 20px;">
                ...
                <?php 
                $default_slug = sanitize_title(pathinfo($selected_ivr, PATHINFO_FILENAME));
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="flow_domain" name="flow_domain" class="regular-text"
                                   ...
                                   placeholder="e.g., flosc.ai or lesaep.com">
                            <p class="description">Custom domain pointing to this flow (optional). <a href="https://flosc.ai/docs/dns" target="_blank">DNS setup guide →</a></p>
                        </td>
                    </tr>
                    <tr>
