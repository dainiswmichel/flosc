# FLOSC v3.0.1 - Quiz Type Framework
...
🎯 **Quiz Type Framework** - FLOSC now supports **5 quiz types** out of the box, with 4 that work with zero configuration!

See [WHATS_NEW.md](WHATS_NEW.md) for full changelog.
