...
The {product_name} Team";
    ...
    public function add_admin_menu() {
        ...
        // Add Settings as first submenu (replaces auto-generated duplicate)
        add_submenu_page(
            'flosc-settings',
            'FLOSC Settings',
            'Settings',
        ...
        // v04_05: AI Orientation Files
        add_submenu_page(
            'flosc-settings',
            'AI Orientation Files',
            'AI Orientation',
            'manage_options',
            'flosc-ai-orientation',
    ...
    public function handle_test_ai($request) {
        ...
        try {
            ...
            // Get AI response
            $response = $this->ai_factory->get_response($test_message, $system_prompt, []);
