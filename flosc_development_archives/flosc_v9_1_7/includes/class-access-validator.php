...
class FLOSC_Access_Validator {
    ...
    public function validate_response($ai_response, $access_level) {
        ...
        if (!empty($violations)) {
            error_log("FLOSC SECURITY: Content leakage prevented for {$access_level}");
            error_log("FLOSC SECURITY: Violations - " . json_encode($violations));
    ...
    public function validate_system_prompt($system_prompt, $access_level) {
        ...
        if (!empty($missing)) {
            error_log("FLOSC WARNING: System prompt missing required phrases for {$access_level}");
            error_log("FLOSC WARNING: Missing - " . json_encode($missing));
        }
