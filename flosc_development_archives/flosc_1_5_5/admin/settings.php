...
<div class="wrap flosc-admin">
    ...
    <div class="flosc-ivr-selector" style="background: #1d2327; padding: 15px 20px; border-radius: 2px; margin-bottom: 20px;">
        <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
            ...
            <?php if (!empty($ivr_backups)): ?>
                <button type="button" id="toggle-backups-btn" onclick="toggleBackups()" class="button button-small" style="font-size: 12px; color: #f0f0f1; background: transparent; border-color: #50575e;">
