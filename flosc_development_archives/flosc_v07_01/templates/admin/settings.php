    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="text" id="flosc_app_slug" name="flosc_app_slug" value="<?php echo esc_attr(get_option('flosc_app_slug', 'app')); ?>" class="regular-text" placeholder="app">
                    <p class="description">
                        Your app will be at: <strong><?php echo esc_html(home_url('/')); ?><span style="color: #2271b1;"><?php echo esc_html(get_option('flosc_app_slug', 'app')); ?></span>/</strong><br>
                        <em>Enter the slug WITHOUT leading or trailing slashes (e.g., "app" not "/app/" or "app/")</em>
                    </p>
                </td>
            </tr>
            <tr>
