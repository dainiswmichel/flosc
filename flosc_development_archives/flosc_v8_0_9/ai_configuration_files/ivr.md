...
Goal: Get them to take the quiz. They CANNOT see score without logging in.
...
They have: name, email, phone. They can see score, get 1 free lesson, cannot retake quiz.
...
They can: retake quiz with Michel Timestamps, see complete score breakdown, access all lessons, access all quizzes.
...
Users who completed quiz but not purchased. They see: quiz results + free preview + upgrade offer
