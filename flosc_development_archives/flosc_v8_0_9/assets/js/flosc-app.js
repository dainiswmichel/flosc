 ...
 * v8.0.9: Robust design - positive state checking, DOM idempotency, always responsive
 */

// v8.0.9: Clear FLOSC-specific localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '8.0.9';
    try {
        ...
        if (stored !== FLOSC_JS_VERSION) {
            ...
            console.log('FLOSC v8.0.9: Storage cleared - fresh session');
        }
    } catch(e) {
