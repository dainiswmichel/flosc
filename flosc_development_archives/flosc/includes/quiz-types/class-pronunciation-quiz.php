<?php
/**
 * Pronunciation Quiz Type
 *
 * Audio-based pronunciation assessment using STT + phoneme analysis.
 * Perfect for language learning, accent coaching, speech therapy.
 *
 * @package FLOSC
 * @version 3.0.1
 */
...
class FLOSC_Pronunciation_Quiz extends FLOSC_Abstract_Quiz_Type {
    ...
    public function get_description() {
        return 'Audio recording with STT transcription and pronunciation analysis. Perfect for language learning.';
    }
    ...
    public function get_instructions() {
        return "Record yourself saying the sentence clearly.";
    }
