...
class FLOSC_IVR_Parser {
    ...
    public function flosc_parse($markdown) {
        ...
        foreach ($lines as $line) {
            ...
            if ($in_message_content) {
                ...
                if (preg_match('/^(MessageName|MessageType|MessageStyle|MessagePanel|Icon|UserInput|Keywords|Action|OfferID|Price|DiscountPrice|Timer|DisplayFormat|HtmlFile|WooProduct|PostID|MessageConditions|##|---):/i', $trimmed) ||
     ...
     */
    private function get_ivr_file_path($flow = null) {
        // If specific flow passed, use its ivr_file
        ...
        // Fallback to flosc_default_ivr.md
    ...
    public function flosc_save_config($markdown, $target_flow = null) {
        ...
        $ivr_file = $this->get_ivr_file_path($target_flow);
