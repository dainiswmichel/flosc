...
class FLOSC_Member_Access {
    ...
    public function grant_level($user_id, $level) {
        ...
        error_log("FLOSC: Granted {$level} membership to user {$user_id}");
    ...
    public function revoke_level($user_id, $level, $reason = '') {
        ...
        error_log("FLOSC: Revoked {$level} membership from user {$user_id}. Reason: {$reason}");
    ...
    public function grant_guest_access($user_id, $post_id) {
        ...
        error_log("FLOSC: Granted guest access to post {$post_id} for user {$user_id}");
