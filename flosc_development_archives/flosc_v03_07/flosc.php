...
class FLOSC_Framework {
    ...
    public function activate() {
        ...
        $force_defaults = [
            ...
            'flosc_get_started_message' => 'Welcome! I\'m your FLOSC learning assistant. I\'m here to help you master new skills through interactive lessons and quizzes. Ready to get started?',
            'flosc_how_it_works_message' => 'Here\'s how it works: First, you\'ll take a quick quiz to assess your current level. Then, based on your results, I\'ll unlock a free lesson personalized to your needs. After that, you can upgrade for full access to all lessons and ongoing support.',
            'flosc_what_you_learn_message' => 'You\'ll master practical skills through interactive lessons, get personalized feedback on your progress, and access a complete learning path designed to take you from beginner to advanced. Each lesson includes exercises, quizzes, and real-world applications.',
        ];
