    ...
    renderLessonList(lessons) {
        const listHtml = `
            <div class="flosc-lesson-list">
                ...
                <div class="flosc-lesson-items">
                    ${lessons.map(lesson => `
                        <div class="flosc-lesson-item" onclick="window.FLOSC.viewLesson(${parseInt(lesson.id)})">
                            <div class="flosc-lesson-item-content">
                                <strong class="flosc-lesson-item-title">${this.escapeHtml(lesson.title)}</strong>
                                ${lesson.excerpt ? `<p class="flosc-lesson-item-excerpt">${this.escapeHtml(lesson.excerpt)}</p>` : ''}
                            </div>
