        ...
        if (isset($data['success']) && $data['success'] && !empty($data['messages'])) {
            ...
            $diagnostics['api_endpoint'] = [
                ...
                'details' => [
                    ...
                    "Click 'Test API Endpoint' for full details"
                ],
                'url' => $api_url
            ];
            ...
            $diagnostics['api_endpoint'] = [
                ...
                'message' => '0 messages',
                'details' => [
                    "API works but returned 0 messages",
                    "Check conditions or load messages from file"
                ],
                'url' => $api_url
            ];
        } else {
            $diagnostics['api_endpoint'] = [
                ...
                'details' => [
                    ...
                    "Click 'Test API Endpoint' for details"
                ],
                'url' => $api_url
            ];
        }
