 ...
 * v8.0.6: Fixed chat responsiveness - user messages now appear immediately
 */

// v8.0.6: Clear localStorage on version change
(function() {
    const FLOSC_JS_VERSION = '8.0.6';
    try {
...
Purchased: ${ctx.purchased}
    ...
    async sendMessage() {
        ...
        // v8.0.6 FIX: Always add user message FIRST (before onUserMessage check)
