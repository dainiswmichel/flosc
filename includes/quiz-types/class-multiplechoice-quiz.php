...
class FLOSC_MultipleChoice_Quiz extends FLOSC_Abstract_Quiz_Type {
    ...
    public function get_default_content() {
        return "How do you make the voiceless TH in \"think\"?|A) Like F — fink|B) Like T — tink|C) Tongue tip near or between the teeth|D) Like S — sink|Correct: C|CorrectContent: post:lesson-35-three-athens-froth|RelatedContent: post:lesson-36-the-feather-scathe, category:sample_lessons|RelatedContent: tag:fricatives, id:1035\nWhich vowel is the schwa?|A) The long A in \"cake\"|B) The unstressed central vowel in \"banana\"|C) The short O in \"hot\"|D) The long E in \"feet\"|Correct: B|CorrectContent: post:lesson-20-1-introduction-to-the-schwa|RelatedContent: post:lesson-20-2-replacing-unstressed-vowels, post:lesson-20-3-exploring-the-schwa|RelatedContent: category:sample_lessons, search:unstressed vowel reduction\nIn fast American English, \"butter\" has what sound in the middle?|A) A crisp T|B) A silent T|C) A D-like flap|D) A glottal stop|Correct: C|CorrectContent: post:lesson-28-t-d-tip-dip-cat-dad|RelatedContent: post:lesson-23-t-t-tap-attack-cat, post:lesson-24-d-dog-adorable-blinded|RelatedContent: id:1028, tag:plosives";
    }
