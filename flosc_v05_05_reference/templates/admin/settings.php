...
<div class="wrap flosc-admin">
    ...
    <nav class="nav-tab-wrapper">
        ...
        <a href="?page=flosc-ai-knowledge" class="nav-tab <?php echo isset($_GET['page']) && $_GET['page'] === 'flosc-ai-knowledge' ? 'nav-tab-active' : ''; ?>">AI Knowledge</a>
        <a href="?page=flosc-offers" class="nav-tab <?php echo isset($_GET['page']) && $_GET['page'] === 'flosc-offers' ? 'nav-tab-active' : ''; ?>">Offers</a>
        <a href="?page=flosc-payments" class="nav-tab <?php echo isset($_GET['page']) && $_GET['page'] === 'flosc-payments' ? 'nav-tab-active' : ''; ?>">Payments</a>
    ...
    <form method="post" action="options.php">
        ...
        <h2>IVR Messages</h2>
        <p><strong>IVR (Interactive Voice Response)</strong> is our framework for delivering contextual messages based on user behavior, FLOSC phase, quiz scores, and conditions. Configure all chatbot responses here.</p>
